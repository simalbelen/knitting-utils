...
function EditProjectForm({ onClose, project }: Props) {
  ...
  const validationSchema = yup.object({
    ...
    row: yup.number().integer().required("Campo obligatorio"),
  });
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        onChange={formik.handleChange}
        isInvalid={formik.touched.row && formik.errors.row ? true : false}
        errorMessage={formik.touched.row && formik.errors.row}
        value={formik.values.row.toString()}
      />
